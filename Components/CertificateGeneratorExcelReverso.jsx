...
//TEXTO DE ORGANIZACION, FECHAS Y HORAS
var tamanoFuente = 65; // Tamaño de fuente en píxeles
...
// Establecer la fuente en negrita para todo el texto de participant
...
for (var i = 0; i < lineas.length; i++) {
  ...
  y += tamanoFuente + 10; // Espacio vertical entre líneas ajustado
}
